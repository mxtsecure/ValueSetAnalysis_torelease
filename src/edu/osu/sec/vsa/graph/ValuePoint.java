...
public class ValuePoint implements IDGNode {
	...
	public static List<ValuePoint> find(DGraph dg, String signature, List<Integer> regIndex) {
		...
		for (StmtPoint sp : sps) {
			...
			// <com.yanzhenjie.nohttp.HttpConnection: com.yanzhenjie.nohttp.Connection handleRedirect(com.yanzhenjie.nohttp.BasicRequest,com.yanzhenjie.nohttp.Headers)>
		}
		Scanner sc = new Scanner(System.in);
		System.out.println("请输入你选择的节点：");
		int node_num = sc.nextInt();
		StmtPoint sp = sps.get(node_num);
